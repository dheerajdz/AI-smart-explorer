...
async function main() {
    ...
    await mongoose_1.default.connect(process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/smart-ai-explorer');
    ...
    bot.command('portfolio', async (ctx) => {
        ...
        try {
            ...
            const portfolio = await mongoose_1.default.connection.db
            ...
            await sendMessage(chatId, 'Sorry, failed to load your portfolio. Please try again.');
        }
    });
    // @ts-ignore
    await bot.launch();
